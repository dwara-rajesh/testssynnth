...
int main() {
    shared.CHORDS = {
    {69, 76, 79, 81, 88, 91},  // A sus2 with octave repeats
    {62, 65, 69, 72, 74, 81},  // D minor7
    {63, 68, 70, 75, 80, 82},  // Eb sus4
    {65, 72, 75, 77, 84, 87},  // F minor7
    {67, 69, 74, 79, 81, 86},  // G sus2
    {60, 64, 67, 71, 72, 79},  // C major7
    {62, 66, 69, 74, 78, 81},  // D sus4
    {64, 68, 71, 76, 80, 83},  // E major7
    {65, 67, 72, 77, 79, 84},  // F sus2
    {67, 71, 74, 79, 83, 86}   // G major7
};
    shared.running = true;
